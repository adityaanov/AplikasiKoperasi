...
public class DaftarPelanggan extends javax.swing.JFrame {
    ...
    public void SelectData(){
        ...
        if(i == -1){
            return;
        }String s = (String) tabelpelanggan.getModel().getValueAt(i, 1);
    }
    ...
    private void tabelpelangganMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelpelangganMouseClicked
        ...
        String id_pelanggan = tabelpelanggan.getValueAt(i, 0).toString();
        FormTransaksi.txt_idplgn.setText(id_pelanggan);
