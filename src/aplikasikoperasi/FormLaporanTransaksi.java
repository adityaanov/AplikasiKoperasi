...
public class FormLaporanTransaksi extends javax.swing.JFrame {
    ...
    public FormLaporanTransaksi(){
        ...
        tabellaporantransaksi.setModel(model);
    ...
    public void LihatTransaksi(){
        ...
        try{
            Connection c = Koneksi.KoneksiDb();
            Statement s = c.createStatement();
            String sql = "Select * From kasir where id_pegawai like '%"+lb_idpegawai.getText()+"&'";
            ResultSet r = s.executeQuery(sql);
    ...
    private void initComponents() {
        ...
        lb_idpegawai.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        lb_idpegawai.setText("ID Pegawai");

        lb_namapegawai.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        lb_namapegawai.setText("Nama Pegawai");

        lb_jabatan.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
