 ...
 * @author adity
 */
public class FormLogAktivitasPegawaiAdmin extends javax.swing.JFrame {
    private DefaultTableModel model;
    
    public FormLogAktivitasPegawaiAdmin() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormLogAktivitasPegawaiAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormLogAktivitasPegawaiAdmin().setVisible(true);
            }
        });
    }
